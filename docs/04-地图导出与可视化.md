...
![](./images/Pasted%20image%2020260327230914.png)]由于我是坐着转动设备，所以我靠近 的一侧点云比较密集

# colmap-return
![](./images/Pasted%20image%2020260402220423.png)
...
# CloudCompare
1. 直接将ply文件拖进来，点击应用![](./images/Pasted%20image%2020260403204611.png)
...
4. cmd运行
   ...
   ```
5. 直接把camera_positions拖进来![](./images/Pasted%20image%2020260403205354.png)注意上面六栏依次为：x y z ignore ignore ignore![](./images/Pasted%20image%2020260403205536.png)

为什么只处理了相机的位置![](./images/Pasted%20image%2020260403210753.png)
![](./images/Pasted%20image%2020260403210736.png)
